...
function Header() {
  return (
    <header id='header'>
        ...
        <div id='divLanguage'>
          <div>
            <img id='portuguese' src={brasil} alt="Portuguese [Bandeira do Brasil]" />
            <img id='english' src={unitedKingdon} alt="English [Flag of the United Kingdon]" />
          </div>
          
          <div id='divColorBody'>
            <div id='bodyDark'></div>
            <div id='bodyLight'></div>
          </div>
